...
func (x *CheckRepose) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CheckRepose) ProtoMessage() {}

func (x *CheckRepose) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[0]
...
// Deprecated: Use CheckRepose.ProtoReflect.Descriptor instead.
func (*CheckRepose) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{0}
}

func (x *CheckRepose) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
type PasswordCheckInfo struct {
	...
	EncryptedPasword string `protobuf:"bytes,2,opt,name=encryptedPasword,proto3" json:"encryptedPasword,omitempty"`
}
...
func (x *PasswordCheckInfo) GetEncryptedPasword() string {
	if x != nil {
		return x.EncryptedPasword
	}
	return ""
}
...
var file_user_proto_rawDesc = []byte{
	...
	,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x60, 0x0a, 0x0e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55,
	...
	0x08, 0x62, 0x69, 0x72, 0x74, 0x68, 0x44, 0x61, 0x79, 0x32, 0xb3, 0x02, 0x0a, 0x04, 0x55, 0x73,
	...
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x31, 0x0a, 0x0d,
	...
	0x6f, 0x1a, 0x0c, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x70, 0x6f, 0x73, 0x65, 0x42,
...
var file_user_proto_depIdxs = []int32{
	...
	0, // 12: User.CheckPassWord:output_type -> CheckRepose
...
type UserClient interface {
	...
	CheckPassWord(ctx context.Context, in *PasswordCheckInfo, opts ...grpc.CallOption) (*CheckRepose, error)
}
...
func (c *userClient) CheckPassWord(ctx context.Context, in *PasswordCheckInfo, opts ...grpc.CallOption) (*CheckRepose, error) {
	out := new(CheckRepose)
...
type UserServer interface {
	...
	CheckPassWord(context.Context, *PasswordCheckInfo) (*CheckRepose, error)
}
...
func (*UnimplementedUserServer) CheckPassWord(context.Context, *PasswordCheckInfo) (*CheckRepose, error) {
